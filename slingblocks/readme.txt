...
We at [FunnelKit](https://funnelkit.com/?utm_source=WordPress&utm_medium=SlingBlocks&utm_campaign=WP+Repo) were looking for a plugin that would seamlessly allow our Funnel Builder to provide templates for Gutenberg.
...
Download [Funnel Builder](https://wordpress.org/plugins/funnel-builder/) and get access to more blocks.
...
* Improved: Plugin security improved. (#210)
* Fixed: UI issues with blocks sidebar. (#206)
* Fixed: Prevent overriding global post if the post is not created using gutenberg for FK checkout. (#204)

= 1.6.0 (Mar 05, 2025) =
* Compatible upto WordPress 6.7
* Fixed: Security enhancements. (#198)
* Compatibility with Gutenberg standalone plugin. (#199)
